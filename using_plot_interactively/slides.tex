...
%\LARGE
\title
[Creating simple plots using IPython]
%\hspace{0.5cm}
...
\begin{itemize}
\item To understand this tutorial, the learner should know how to run basic Python commands on the  \texttt{ipython} console \pause
\item If not, for relevant Python tutorials, please visit this website.  {\color{blue}\url{http://spoken-tutorial.org}}
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
